...
extern int invalid_date(const struct tm *ptm)
{
...
extern void dosdate_to_raw_tm(uint64_t dos_date, struct tm *ptm)
{
...
extern FILE *get_file_handle(const char *path)
{
    FILE *handle = NULL;
#if defined(WIN32)
